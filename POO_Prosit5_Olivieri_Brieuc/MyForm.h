...
namespace POOProsit5OlivieriBrieuc {
	...
	/// </summary>
	public ref class MyForm : public System::Windows::Forms::Form // ajout de : public System::Windows::Forms::Form
	{
	public:
		MyForm(void)
		{
...
#pragma endregion
	...
	private: System::Void btn_source_Click(System::Object^ sender, System::EventArgs^ e) //ajout des parenthèses ainsi que de leur contenu
	{
		int i;
